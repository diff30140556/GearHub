                ...
                <div className="product-section">
                    <div className="product-box product-1 d-flex justify-content-center">
                        <Row className="justify-content-center align-items-center flex-column-reverse flex-md-row mx-0">
                            <Col sm={12} md={5}>
                                <div className="product-info" data-aos="fade-up"  data-aos-duration="1000" data-aos-once="true">
                            ...
                            <Col sm={12} md={7}>
                                <div className="product-img" data-aos-once="true" data-aos="fade-up" data-aos-delay="300" data-aos-duration="1000">
                    ...
                    <div className="product-box product-2 d-flex justify-content-center">
                        <Row className="justify-content-center align-items-center flex-column-reverse flex-md-row mx-0">
                            <Col sm={12} md={5}>
                                <div className="product-info" data-aos-offset="120" data-aos="fade-up"  data-aos-duration="1000" data-aos-once="true">
